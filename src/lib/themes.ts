...
export type ThemeVoice = {
  ...
  nearbyHost: string;
  nearbyJoin: string;
  nearbyEndpointLabel: string;
  nearbyKeepAwake: string;
  networkLabel: string;
  networkOnline: string;
  networkNearby: string;
...
export const THEME_VOICES: Record<ThemeId, ThemeVoice> = {
  retro: {
    ...
    difficultyHard: "HARD",
    playVsBots: "ADD BOTS IN LOBBY",
    findMatch: "FIND PUBLIC",
    findPublicGame: "FIND PUBLIC",
    nearbyHost: "HOST NEARBY",
    nearbyJoin: "JOIN NEARBY",
    nearbyEndpointLabel: "HOST ENDPOINT",
    nearbyKeepAwake: "Keep this device awake while hosting nearby.",
    networkLabel: "NETWORK",
    networkOnline: "Online",
    networkNearby: "Nearby",
  ...
  party: {
    ...
    createGame: "Open a lobby!",
    createLobby: "Open a lobby!",
    join: "Jump in!",
